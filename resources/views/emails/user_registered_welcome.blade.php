...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>We're excited to have you on board at <strong>{{ $tenant->name }}</strong>, hosted on the <strong>{{ config('app.name') }}</strong> platform.</p>
      ...
      <p>Welcome aboard!<br><strong>{{ config('app.name') }} Team</strong></p>
    </div>
