                ...
                <td v-for="col in visibleColumns" :key="col.key">
                  <template v-if="col.key === 'customer_info'">
                    ...
                    <div class="small text-muted">
                      ...
                      <!-- <button v-if="order.customer?.email" class="btn btn-link btn-copy ms-1 p-0" @click.stop="copyToClipboard(order.customer.email, 'Email')" title="Copy Email"><i class="fas fa-copy"></i></button> -->
                    </div>
                    <div class="small text-muted">
                      {{ $t('tenant_dashboard.orders.phone') }}: {{ order.customer?.phone || '-' }}
                      <!-- <button v-if="order.customer?.phone" class="btn btn-link btn-copy ms-1 p-0" @click.stop="copyToClipboard(order.customer.phone, 'Phone')" title="Copy Phone"><i class="fas fa-copy"></i></button> -->
                    </div>
                  </template>
    ...
    style="background:rgba(0,0,0,0.25);">
      ...
      <div class="modal-content print-area">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2 px-3">
          <h4 class="modal-title flex-grow-1 mb-0">{{ $t('tenant_dashboard.orders.orderDetails') }}</h4>
              ...
              <div class="col-md-4">
                ...
                <div class="status-area ">
                  ...
                  <span class="position-relative">
                    <!-- <span :class="['badge', 'status-badge', selectedOrder.status]" :title="statusTooltip">
