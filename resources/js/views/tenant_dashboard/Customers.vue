...
export default {
  ...
  setup() {
    ...
    // Column filter logic
    const allColumns = [
      { key: 'name', label: $t('tenant_dashboard.customers.name') },
      { key: 'email', label: $t('tenant_dashboard.customers.email') },
      { key: 'phone', label: $t('tenant_dashboard.customers.phone') },
      { key: 'device_info', label: $t('tenant_dashboard.customers.deviceInfo') },
      { key: 'status', label: $t('tenant_dashboard.customers.status') },
      { key: 'created_at', label: $t('tenant_dashboard.customers.createdAt') },
      { key: 'creator', label: $t('tenant_dashboard.customers.createdBy') },
    ];
    ...
    const viewCustomer = async (id) => {
      ...
      if (!viewCustomerModal) {
        viewCustomerModal = new Modal(document.getElementById('viewCustomerModal'))
      }
